...
import (
	...
	publicsvr "github.com/ntaylor-barnett/BatchvStreamTest/gen/grpc/public/server"
...
func handleGRPCServer(ctx context.Context, u *url.URL, publicEndpoints *public.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
	...
	// responses.
	var (
		publicServer *publicsvr.Server
	)
	{
		publicServer = publicsvr.New(publicEndpoints, nil, nil)
	}
	...
	publicpb.RegisterPublicServer(srv, publicServer)
